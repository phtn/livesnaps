export const icons = {
  ...
  livesnaps: {
    symbol:
      '<g clip-path="url(#a)"><path stroke="d9d9d9" stroke-linecap="round" stroke-width="5" d="M12.258 8.125h24.5"/><path fill="#fafafa" d="M81.708 57.195a24.513 24.513 0 1 1 0 49.026 24.513 24.513 0 0 1 0-49.026"/><path fill="currentColor" d="M49 16.342H37.58l-7.523 10.484c-3.283 4.575-2.621 10.914 1.535 14.71l9.195 8.4-9.507-7.013a10.91 10.91 0 0 0-15.077 2.045L4.03 60.441l11.137-16.153c3.344-4.789 2.407-11.382-2.137-15.041l-7.856-6.33A19.93 19.93 0 0 0 0 36.342v82.138c0 15.792 12.81 28.594 28.602 28.594h106.211c15.791 0 28.602-12.802 28.602-28.594V39.869c0-12.994-10.534-23.527-23.527-23.527h-23.047L100.5 0H65.342zm-29 0h16.614l-8.56 10.081a10.907 10.907 0 0 1-14.45 1.983l-8.308-5.622A19.95 19.95 0 0 1 20 16.342m32.82 36.477a40.854 40.854 0 1 1 57.776 57.777A40.854 40.854 0 0 1 52.819 52.82m99.319-24.217a17.325 17.325 0 0 0-24.503 0 17.328 17.328 0 0 0 12.252 29.578 17.325 17.325 0 0 0 12.251-29.578"/><path fill="#a62e2e" d="M139.888 23.527a17.325 17.325 0 0 1 17.326 17.327 17.324 17.324 0 0 1-17.326 17.326 17.326 17.326 0 1 1 0-34.653"/></g><defs><clipPath><path fill="currentColor" d="M0 0h164v148H0z"/></clipPath></defs>',
    viewBox: '0 0 164 148',
    set: 'svg'
  },
  theme: {
  ...
  ocr: {
    symbol:
      '<path fill="currentColor" d="M2 5v14h12v-2h-2c-1.11 0-2-.89-2-2V9c0-1.11.89-2 2-2h2V5m0 2v2h2V7m-2 2h-2v6h2m0 0v2h2v-2M5 7h2c1.11 0 2 .89 2 2v6c0 1.11-.89 2-2 2H5c-1.11 0-2-.89-2-2V9c0-1.11.89-2 2-2m12 0v10h2v-4h1v1h1v3h2v-3h-1v-2h1V8h-1V7M5 9v6h2V9m12 0h2v2h-2Z"/>',
    viewBox: '0 0 24 24',
    set: 'mdi'
  },
  bolt: {
  ...
  'car-back': {
    symbol:
      '<path fill="currentColor" d="m6 11l1-4h10l1 4m.92-5c-.21-.6-.78-1-1.42-1h-11c-.64 0-1.21.4-1.42 1L3 12v8a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-2h12v2a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-8zM7 16H5v-2h2zm12 0h-2v-2h2zm-5 0h-4v-2h4z"/>',
    viewBox: '0 0 24 24',
    set: 'mdi'
  },
  'car-side': {
  ...
  'car-odo': {
    symbol:
      '<path fill="currentColor" d="M512 896a384 384 0 1 0 0-768a384 384 0 0 0 0 768m0 64a448 448 0 1 1 0-896a448 448 0 0 1 0 896"/><path fill="currentColor" d="M192 512a320 320 0 1 1 640 0a32 32 0 1 1-64 0a256 256 0 1 0-512 0a32 32 0 0 1-64 0"/><path fill="currentColor" d="M570.4 627.8a96 96 0 1 1-60.8-19.8l61-187.8a32 32 0 1 1 60.8 19.8zm-68.3 106.7a32 32 0 1 0 19.8-61a32 32 0 0 0-19.8 61"/>',
    viewBox: '0 0 1024 1024',
    set: 'ep'
  },
  location: {
    symbol:
      '<path fill="currentColor" d="M512 928c24 0 117.5-68.4 192-153.2c99.5-113 160-239 160-358.8c0-189.6-155.8-320-352-320S160 226.4 160 416c0 120.3 60.5 246.4 160 359.2C394.3 859.8 488 928 512 928m0-435.2a64 64 0 1 0 0-128a64 64 0 0 0 0 128m0 140.8a204.8 204.8 0 1 1 0-409.6a204.8 204.8 0 0 1 0 409.6"/>',
    viewBox: '0 0 1024 1024',
    set: 'ep'
  },
  sparkle: {
    symbol:
      '<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.25" d="M21 12c-6.597 0-9 2.403-9 9c0-6.597-2.403-9-9-9c6.597 0 9-2.403 9-9c0 6.597 2.403 9 9 9"/>',
    viewBox: '0 0 24 24',
    set: 'tabler'
  },
  'circle-plus': {
  ...
  gallery: {
    symbol:
      '<path fill="currentColor" fill-rule="evenodd" d="M5 3a3 3 0 0 0-3 3v10a2 2 0 0 0 2 2V6a1 1 0 0 1 1-1h14a2 2 0 0 0-2-2zm0 5a2 2 0 0 1 2-2h13a2 2 0 0 1 2 2v11.333a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2zm15 0H7v8.848L10.848 13a1.25 1.25 0 0 1 1.768 0l3.241 3.24l.884-.883a1.25 1.25 0 0 1 1.768 0L20 16.848zm-2 3a1.5 1.5 0 1 1-3 0a1.5 1.5 0 0 1 3 0" clip-rule="evenodd"/>',
    viewBox: '0 0 24 24',
    set: 'mingcute'
  },
  attachment: {
    symbol:
      '<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" d="m12.877 4.308l6.54 6.54a5.25 5.25 0 0 1-7.424 7.425l-7.954-7.954a3.501 3.501 0 1 1 4.952-4.952l7.953 7.953a1.751 1.751 0 1 1-2.477 2.477L7.22 8.55"/>',
    viewBox: '0 0 24 24',
    set: 'mingcute'
  },
  'download-line': {
  ...
  'email-body': {
    symbol:
      '<path fill="currentColor" d="M20 4H4c-1.11 0-2 .89-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2m-3 13H7v-2h10m0-2H7v-2h10m3-2h-3V6h3"/>',
    viewBox: '0 0 24 24',
    set: 'mdi'
  },
  gps: {
  ...
  cancel: {
    symbol:
      '<path fill="currentColor" d="M22.11 21.46L2.39 1.73L1.11 3l2.95 2.95A9.95 9.95 0 0 0 2 12c0 5.5 4.5 10 10 10c2.28 0 4.37-.77 6.05-2.06l2.79 2.79zM12 20c-4.42 0-8-3.58-8-8c0-1.73.56-3.32 1.5-4.62L16.62 18.5A7.78 7.78 0 0 1 12 20M8.17 4.97L6.72 3.5C8.25 2.56 10.06 2 12 2c5.5 0 10 4.5 10 10c0 1.94-.56 3.75-1.5 5.28l-1.47-1.45c.62-1.14.97-2.44.97-3.83c0-4.42-3.58-8-8-8c-1.39 0-2.69.35-3.83.97"/>',
    viewBox: '0 0 24 24',
    set: 'mdi'
  },
  'alert-octagon-fill': {
  ...
  'circle-minus': {
    symbol:
      '<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 12h8m5 0a9 9 0 1 1-18 0a9 9 0 0 1 18 0Z"/>',
    viewBox: '0 0 24 24',
    set: 'mingcute'
  },
  workspaces: {
    symbol:
      '<g transform="scale(0.667)"><path d="M15 20c0-.55-.45-1-1-1h-1v-2h6c1.11 0 2-.89 2-2V7a2 2 0 0 0-2-2h-6l-2-2H5c-1.1 0-2 .9-2 2v10a2 2 0 0 0 2 2h6v2h-1c-.55 0-1 .45-1 1H2v2h7c0 .55.45 1 1 1h4c.55 0 1-.45 1-1h7v-2zM5 15V7h14v8z" fill="currentColor"/></g>',
    viewBox: '0 0 16 16',
    set: 'svg'
  },
  workspace: {
  ...
  'camera-enhance': {
    symbol:
      '<path fill="currentColor" d="M9 3L7.17 5H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-3.17L15 3m-3 15a5 5 0 0 1-5-5a5 5 0 0 1 5-5a5 5 0 0 1 5 5a5 5 0 0 1-5 5m0-1l1.25-2.75L16 13l-2.75-1.25L12 9l-1.25 2.75L8 13l2.75 1.25"/>',
    viewBox: '0 0 24 24',
    set: 'mdi'
  },
  'camera-off': {
    symbol:
      '<path fill="currentColor" d="M17 12c0 .54-.1 1.05-.26 1.54L15 11.78A3.06 3.06 0 0 0 12.22 9l-1.76-1.74c.49-.16 1-.26 1.54-.26c2.76 0 5 2.24 5 5M9.88 4h4.24l1.83 2H20v10.8l1.88 1.88c.08-.21.12-.44.12-.68V6c0-1.11-.89-2-2-2h-3.17L15 2H9L7.18 4L8.6 5.4zm12.23 17.46l-1.27 1.27L18.11 20H4a2 2 0 0 1-2-2V6c0-.58.25-1.1.65-1.46L1.11 3l1.28-1.27zM9 12c0 1.66 1.34 3 3 3c.33 0 .65-.07.94-.17l-3.77-3.77c-.1.3-.17.61-.17.94m7.11 6l-1.66-1.66c-.73.41-1.56.66-2.45.66c-2.76 0-5-2.24-5-5c0-.89.25-1.72.66-2.45L4.11 6H4v12z"/>',
    viewBox: '0 0 24 24',
    set: 'mdi'
  },
  goog: {
    symbol:
      '<path fill="currentColor" d="M16.318 13.714v5.484h9.078c-.37 2.354-2.745 6.901-9.078 6.901c-5.458 0-9.917-4.521-9.917-10.099s4.458-10.099 9.917-10.099c3.109 0 5.193 1.318 6.38 2.464l4.339-4.182C24.251 1.584 20.641.001 16.318.001c-8.844 0-16 7.151-16 16s7.156 16 16 16c9.234 0 15.365-6.49 15.365-15.635c0-1.052-.115-1.854-.255-2.651z"/>',
    viewBox: '0 0 32 32',
    set: 'cib'
  },
  'safe-shield': {
    symbol:
      '<path fill="none" stroke="currentColor" stroke-width="2" d="M12 3.01v17.98m-3.578-1.779l3.354 1.677a.5.5 0 0 0 .448 0l3.354-1.677A8 8 0 0 0 20 12.056V6.693a1 1 0 0 0-.649-.936l-7-2.625a1 1 0 0 0-.702 0l-7 2.625A1 1 0 0 0 4 6.693v5.363a8 8 0 0 0 4.422 7.155Z"/>',
    viewBox: '0 0 24 24',
    set: 'mingcute'
  },
  settings: {
  ...
  snap: {
    symbol:
      '<g transform="scale(0.667)"><path d="M22 13a1 1 0 1 0-2 0zm-8-8a1 1 0 1 0 0-2zm6-2 .946-.323a1 1 0 0 0-1.892 0zm3 3 .323.946a1 1 0 0 0 0-1.892zm-3 3-.946.323a1 1 0 0 0 1.892 0zm-3-3-.323-.946a1 1 0 0 0 0 1.892zm2.87-2.622-.946-.323zm0 5.244.947-.323zM8.708 4.292 8 3.587zM7.293 5.708 8 6.414zm12.836 2.915-.946-.323zM21 13h-1v6h2v-6zm-1 7v-1H4v2h16zM3 19h1V7H2v12zM4 6v1h2.586V5H4zm3.293-.293L8 6.414 9.414 5l-.707-.707L8 3.586 6.586 5zM9.414 4v1H14V3H9.414zM16 12.5h-1a3 3 0 0 1-3 3v2a5 5 0 0 0 5-5zm-4 4v-1a3 3 0 0 1-3-3H7a5 5 0 0 0 5 5zm-4-4h1a3 3 0 0 1 3-3v-2a5 5 0 0 0-5 5zm4-4v1a3 3 0 0 1 3 3h2a5 5 0 0 0-5-5zM20 3l-.946.323.129.378.946-.323.947-.323-.13-.378zm2.622 2.87-.323.947.378.13L23 6l.323-.946-.378-.13zM23 6l-.323-.946-.378.129.323.946.323.946.378-.129zm-2.87 2.622-.947-.323-.13.378L20 9l.946.323.13-.378zM20 9l.946-.323-.129-.378-.946.323-.947.323.13.378zm-2.622-2.87.323-.947-.378-.13L17 6l-.323.946.378.13zM17 6l.323.946.378-.129-.323-.946-.323-.946-.378.129zm2.87-2.622.947.323.13-.378L20 3l-.946-.323-.13.378zm-2.492 2.493.323.946a5 5 0 0 0 3.116-3.116l-.946-.323-.947-.323a3 3 0 0 1-1.869 1.87zm2.493 2.75.946-.322a5 5 0 0 0-3.116-3.116l-.323.946-.323.946a3 3 0 0 1 1.87 1.87zM8.707 4.294 9.414 5V3A2 2 0 0 0 8 3.586zM6.586 6v1A2 2 0 0 0 8 6.414l-.707-.707L6.586 5zm16.036.13-.323-.947a5 5 0 0 0-3.116 3.116l.946.323.947.323a3 3 0 0 1 1.869-1.87zM3 7h1V5a2 2 0 0 0-2 2zm1 13v-1H2a2 2 0 0 0 2 2zM20.13 3.378l-.947.323a5 5 0 0 0 3.116 3.116l.323-.946.323-.946a3 3 0 0 1-1.87-1.87zM21 19h-1v2a2 2 0 0 0 2-2z" fill="currentColor"/></g>',
    viewBox: '0 0 16 16',
    set: 'svg'
  },
  filter: {
  ...
  cols: {
    symbol:
      '<g transform="scale(0.667)"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 4v16m6-16v16M5 20h14a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1H5a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1"/></g>',
    viewBox: '0 0 16 16',
    set: 'svg'
  },
  globe: {
  ...
  sidebar: {
    symbol:
      '<g transform="scale(0.667)"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="m9 9.5-6 6M9 4l-6 6m6 5-5 5M9 3v18M3 5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></g>',
    viewBox: '0 0 16 16',
    set: 'svg'
  },
  images: {
  ...
  'email-setting': {
    symbol:
      '<g transform="scale(0.667)"><path d="M12 20a1 1 0 1 0 0-2zm8-9a1 1 0 1 0 2 0zm-1 4 .946-.323a1 1 0 0 0-1.892 0zm3 3 .323.946a1 1 0 0 0 0-1.892zm-3 3-.946.323a1 1 0 0 0 1.892 0zm-3-3-.323-.946a1 1 0 0 0 0 1.892zm.378-.13-.323-.946zm2.493-2.492-.947-.323zm.258 0-.946.323zm-7.45-1.645.641-.768zm.641 0-.64-.768zm6.55 6.889-.946.323zm-2.492-2.493-.323.947zm2.751 2.493-.946-.323zM4 5v1h16V4H4zM3 18h1V6H2v12zm8.68-4.267.64-.768-8.68-7.233L3 6.5l-.64.768 8.68 7.234zM21 6.5l-.64-.768-8.68 7.233.64.768.64.768 8.68-7.233zM12 19v-1H4v2h8zm9-13h-1v5h2V6zm-2 9-.946.323.129.378.946-.323.947-.323-.13-.378zm2.622 2.87-.323.947.378.13L22 18l.323-.946-.378-.13zM22 18l-.323-.946-.378.129.323.946.323.947.378-.13zm-2.87 2.622-.947-.323-.13.378L19 21l.946.323.13-.378zM19 21l.946-.323-.129-.378-.946.323-.947.323.13.378zm-2.622-2.87.323-.947-.378-.13L16 18l-.323.946.378.13zM16 18l.323.946.378-.129-.323-.946-.323-.947-.378.13zm2.87-2.622.947.323.13-.378L19 15l-.946-.323-.13.378zm-2.492 2.493.323.946a5 5 0 0 0 3.116-3.116l-.946-.323-.947-.323a3 3 0 0 1-1.869 1.87zm2.751-2.493-.946.323a5 5 0 0 0 3.116 3.116l.323-.946.323-.947a3 3 0 0 1-1.87-1.869zm-7.45-1.645-.64.768a1.5 1.5 0 0 0 1.921 0l-.64-.768-.64-.768a.5.5 0 0 1 .64 0zm7.192 6.889.946-.323a5 5 0 0 0-3.116-3.116l-.323.946-.323.947a3 3 0 0 1 1.87 1.869zM3 18H2a2 2 0 0 0 2 2v-2zM20 5v1h2a2 2 0 0 0-2-2zm1.622 13.13-.323-.947a5 5 0 0 0-3.116 3.116l.946.323.947.323a3 3 0 0 1 1.869-1.87zM4 5V4a2 2 0 0 0-2 2h2z" fill="currentColor"/></g>',
    viewBox: '0 0 16 16',
    set: 'svg'
  },
  at: {
  ...
  send: {
    symbol:
      '<path d="M14.295 3.243a.667.667 0 0 0-.788-.887L1.835 5.357a.667.667 0 0 0-.296 1.128l3.464 3.312v3.015a.334.334 0 0 0 .57.235l1.382-1.383 2.255 2.158a.667.667 0 0 0 1.083-.24zM6.515 9.88 5.358 8.773l7.315-4.771z" fill="currentColor"/>',
    viewBox: '0 0 16 16',
    set: 'svg'
  },
  logoff: {
    symbol:
      '<path d="M8.004 1.334a6.67 6.67 0 1 1 0 13.34 6.67 6.67 0 0 1 0-13.34m2.83 3.84a.667.667 0 0 0-.944 0L5.175 9.89a.667.667 0 1 0 .943.943l4.716-4.715a.667.667 0 0 0 0-.943" fill="currentColor"/>',
    viewBox: '0 0 16 16',
    set: 'svg'
  },
  logout: {
  ...
  admin: {
    symbol:
      '<g transform="scale(0.667)"><path d="M11 2a5 5 0 1 0 0 10 5 5 0 0 0 0-10m0 11c-2.395 0-4.575.694-6.178 1.672-.8.488-1.484 1.064-1.978 1.69C2.358 16.976 2 17.713 2 18.5c0 .845.411 1.511 1.003 1.986.56.45 1.299.748 2.084.956C6.665 21.859 8.771 22 11 22q.346 0 .685-.005a1 1 0 0 0 .89-1.428A6 6 0 0 1 12 18c0-1.252.383-2.412 1.037-3.373a1 1 0 0 0-.72-1.557Q11.67 13 11 13m9.616 2.469a1 1 0 1 0-1.732-1l-.336.582a3 3 0 0 0-1.097-.001l-.335-.581a1 1 0 1 0-1.732 1l.335.58a3 3 0 0 0-.547.951H14.5a1 1 0 0 0 0 2h.671a3 3 0 0 0 .549.95l-.336.581a1 1 0 1 0 1.732 1l.336-.581c.359.066.73.068 1.097 0l.335.581a1 1 0 1 0 1.732-1l-.335-.58c.242-.284.426-.607.547-.951h.672a1 1 0 1 0 0-2h-.671a3 3 0 0 0-.549-.95z" fill="currentColor"/></g>',
    viewBox: '0 0 16 16',
    set: 'svg'
  },
  edit: {
  ...
  link: {
    symbol:
      '<g transform="scale(0.667)"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="m9 15 6-6m-4-3 .463-.536a5 5 0 0 1 7.071 7.072L18 13m-5 5-.397.534a5.07 5.07 0 0 1-7.127 0 4.97 4.97 0 0 1 0-7.071L6 11"/></g>',
    viewBox: '0 0 16 16',
    set: 'svg'
  },
  'select-caret': {
  ...
  message: {
    symbol:
      '<g transform="scale(0.667)"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 9h8m-8 4h3m-3.667 5H19a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14.5a.25.25 0 0 0 .4.2l3.333-2.5a1 1 0 0 1 .6-.2Z"/></g>',
    viewBox: '0 0 16 16',
    set: 'svg'
  },
  copy: {
  ...
  sheets: {
    symbol:
      '<g transform="scale(0.667)"><path d="M19 11V9h-8V5H9v4H5v2h4v8h2v-8zm0-8c.5 0 1 .2 1.39.61C20.8 4 21 4.5 21 5v14c0 .5-.2 1-.61 1.39-.39.41-.89.61-1.39.61H5c-.5 0-1-.2-1.39-.61C3.2 20 3 19.5 3 19V5c0-.5.2-1 .61-1.39C4 3.2 4.5 3 5 3z" fill="currentColor"/></g>',
    viewBox: '0 0 16 16',
    set: 'svg'
  },
  xlsx: {
    symbol:
      '<g transform="scale(0.667)"><path d="M21.17 3.25q.33 0 .59.25.24.24.24.58v15.84q0 .34-.24.58-.26.25-.59.25H7.83q-.33 0-.59-.25-.24-.24-.24-.58V17H2.83q-.33 0-.59-.24Q2 16.5 2 16.17V7.83q0-.33.24-.59Q2.5 7 2.83 7H7V4.08q0-.34.24-.58.26-.25.59-.25M7 13.06l1.18 2.22h1.79L8 12.06l1.93-3.17H8.22L7.13 10.9l-.04.06-.03.07q-.26-.53-.56-1.07-.25-.53-.53-1.07H4.16l1.89 3.19L4 15.28h1.78m8.1 4.22V17H8.25v2.5m5.63-3.75v-3.12H12v3.12m1.88-4.37V8.25H12v3.13M13.88 7V4.5H8.25V7m12.5 12.5V17h-5.62v2.5m5.62-3.75v-3.12h-5.62v3.12m5.62-4.37V8.25h-5.62v3.13M20.75 7V4.5h-5.62V7Z" fill="currentColor"/></g>',
    viewBox: '0 0 16 16',
    set: 'svg'
  },
  csv: {
    symbol:
      '<g transform="scale(0.667)"><path d="M12 3C7.58 3 4 4.79 4 7s3.58 4 8 4 8-1.79 8-4-3.58-4-8-4M4 9v3c0 2.21 3.58 4 8 4s8-1.79 8-4V9c0 2.21-3.58 4-8 4s-8-1.79-8-4m0 5v3c0 2.21 3.58 4 8 4s8-1.79 8-4v-3c0 2.21-3.58 4-8 4s-8-1.79-8-4" fill="currentColor"/></g>',
    viewBox: '0 0 16 16',
    set: 'svg'
  },
  sheet: {
    symbol:
      '<g transform="scale(0.667)"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2zm0 5h18M10 3v18"/></g>',
    viewBox: '0 0 16 16',
    set: 'svg'
  },
  'sort-caret': {
    symbol:
      '<path d="M7.532 2.196a.667.667 0 0 1 .944 0l4.002 4.002.048.055.004.005.01.015.029.04.006.01.005.006.009.018.016.03.005.01.006.014.008.022.01.022.005.017.005.013.004.018.008.024.002.019.004.017.002.017.004.022.002.02.002.019v.017l.001.022-.001.022v.017l-.002.018-.002.021-.003.02-.003.02-.004.015-.002.02-.008.024-.004.018-.005.012-.005.018-.01.022-.008.022-.006.012-.005.012-.016.03-.01.018-.004.006-.006.01-.028.04-.008.012-.003.002-.004.007a.7.7 0 0 1-.103.102l-.006.004-.015.01-.038.029-.011.006-.006.005-.019.009-.029.016-.012.005-.012.006-.022.008-.022.01-.016.004-.014.006-.018.004-.024.008-.02.002-.016.004-.018.002-.021.004-.021.002-.018.002h-.017l-.022.001H4.002a.667.667 0 0 1-.472-1.139zm4.474 6.475.022.001h.017l.018.002.021.002.02.004.02.002.015.004.02.002.024.008.018.004.012.005.018.005.022.01.022.008.012.006.012.005.03.016.018.01.006.004.01.006.035.025.017.011.002.003.007.004a.7.7 0 0 1 .102.103l.004.006.01.013.029.04.006.011.005.006.009.019.016.029.003.008.008.016.008.022.01.022.005.018.005.013.004.017.008.024.002.02.004.016.002.018.004.021.002.021.002.018v.017l.001.022-.001.022v.017l-.002.018-.002.021-.004.02-.002.02-.004.015-.002.02-.008.024-.004.018-.005.012-.005.018-.01.022-.008.022-.006.012-.005.012-.016.03-.01.018-.004.006-.006.01-.028.04-.008.012-.003.002-.004.007-.048.054-4.002 4.002a.667.667 0 0 1-.944 0L3.53 9.81a.667.667 0 0 1 .472-1.139z" fill="currentColor"/>',
    viewBox: '0 0 16 16',
    set: 'svg'
  },
  'sort-descending': {
    symbol:
      '<path d="M12.006 6.003c.568 0 .865.658.522 1.083l-.05.056-4.002 4.002a.67.67 0 0 1-.88.055l-.064-.055L3.53 7.142l-.055-.063-.036-.051-.036-.065-.011-.024-.018-.044-.022-.072-.006-.036-.007-.04-.003-.038v-.078l.004-.039.006-.04.006-.035.022-.072.018-.044.046-.089.044-.06.048-.054.063-.055.051-.036.065-.036.024-.011.044-.018.072-.022.036-.006.04-.007.038-.003z" fill="currentColor"/>',
    viewBox: '0 0 16 16',
    set: 'svg'
  },
  'sort-ascending': {
    symbol:
      '<path d="M7.532 4.864a.67.67 0 0 1 .88-.055l.064.055 4.002 4.002.055.063.036.051.036.065.011.024.018.044.022.072.006.036.007.04.003.038.001.039-.001.04-.004.038-.006.04-.006.035-.022.072-.018.044-.046.089-.044.06-.048.054-.063.055-.051.036-.065.036-.024.011-.044.018-.072.022-.036.006-.04.007-.038.003-.039.001H4.002a.668.668 0 0 1-.522-1.083l.05-.056z" fill="currentColor"/>',
    viewBox: '0 0 16 16',
    set: 'svg'
  },
  logs: {
    symbol:
      '<g transform="scale(0.667)"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12h.01M4 6h.01M4 18h.01M8 18h2m-2-6h2M8 6h2m4 0h6m-6 6h6m-6 6h6"/></g>',
    viewBox: '0 0 16 16',
    set: 'svg'
  }
}
