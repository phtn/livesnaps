export const icons = {
  ...
  cols: {
    symbol:
      '<g transform="scale(0.667)"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M12 4v16m-7 0h14a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1H5a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1Z"/></g>',
    viewBox: '0 0 16 16',
    set: 'svg'
  },
  globe: {
