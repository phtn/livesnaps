...
import Headline from './headline.btsx'

<TitleHeader title='Terms of Use' effectiveDate='August 8, 2026' lastUpdated='September 16, 2026' />
...
## 11. **Location Services and Network Information**

To use certain features of the Site and App, such as capturing and submitting photos, you MUST enable Location Services on your device and allow the Site or App to access your precise location. We use your device's location services to determine your GPS coordinates, including your latitude, longitude, and location accuracy, along with related readings such as altitude, heading, and speed where your device provides them. Your location is monitored while a capture session is active, and is recorded when the session begins, with each photo you take, and when the session ends. Your location must be accurate to within 20 meters. If you deny location access, turn off Location Services, or your device cannot determine a sufficiently accurate location, you will not be able to use these features. The location information collected is stored with your submission and is used to verify where the submission was made.

When you start a capture session, we send your GPS coordinates to Mapbox (mapbox.com), a third-party mapping provider, to convert them into a street address, such as the street, neighborhood, city, region, postal code, and country of your location. We store this address with your submission. Your coordinates are handled in accordance with Mapbox's own terms and privacy practices.

When you start a capture session, we also send your IP address to IPinfo (ipinfo.io), a third-party IP data provider, to determine your internet service provider, including its name, domain, and autonomous system number (ASN), as well as the country and continent associated with your network. We store this information with your submission and use it to verify the authenticity of your submission, including by comparing the country of your network against the country of your device location, and to help prevent fraud and misuse. If your network information cannot be determined, you may not be able to complete a capture session. Your IP address is handled in accordance with IPinfo's own terms and privacy practices. By using these features, you consent to the collection and use of your location and network information as described in these Terms and in our [Privacy Policy](/legal/privacy-policy).
