...
const adminSettingsRecipientsRoute = createRoute({
  getParentRoute: () => adminSettingsRoute,
  path: 'recipients',
  component: lazyRoute(() => import('./pages/admin-settings-recipients-page.btsx'))
})
...
const adminSettingsAccountRoute = createRoute({
  getParentRoute: () => adminSettingsRoute,
  path: 'account',
  component: lazyRoute(() => import('./pages/admin-settings-account-page.btsx'))
})
...
const citadelSettingsEmailRoute = createRoute({
  getParentRoute: () => citadelSettingsRoute,
  path: 'email',
  component: lazyRoute(() => import('./pages/citadel-settings-email-page.btsx'))
})
